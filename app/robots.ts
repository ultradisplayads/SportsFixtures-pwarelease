...
export default function robots(): MetadataRoute.Robots {
  ...
  return {
    rules: [
      ...
      { userAgent: "ClaudeBot", allow: allowList, disallow: disallowList },
      { userAgent: "PerplexityBot", allow: allowList, disallow: disallowList },
      { userAgent: "Google-Extended", allow: allowList, disallow: disallowList },
